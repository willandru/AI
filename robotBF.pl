...
costoRobot([Ro_i,,,],[Ro_f,,,], Costo):- (Ro_i==Ro_f), Costo is 0.
costoRobot([Ro_i,,,],[Ro_f,,,], Costo):- (Ro_i\==Ro_f), Costo is 2.

costoCa([,Ca_i,,],[,Ca_f,,], Costo):- (Ca_i==Ca_f), Costo is 0.
costoCa([,Ca_i,,],[,Ca_f,,], Costo):- (Ca_i\==Ca_f), Costo is 2.

costoCv([,,Cv_i,],[,,Cv_f,], Costo):- (Cv_i==Cv_f), Costo is 0.
costoCv([,,Cv_i,],[,,Cv_f,], Costo):- (Cv_i\==Cv_f), Costo is 2.

costoPinza([,,,P_i],[,,,P_f],Dif):- (P_i==P_f), Dif is 0.
costoPinza([,,,P_i],[,,,P_f],Dif):- (P_i\==P_f), Dif is 2.
...
%State nodo actual, Parent es el padre del nodo actual, Goal costo de donde estoy al final, Padre heuristica del padre
...
%Se realiza backtracking en caso de que no se encuentra la solucion en un nodo hijo
path(Open, Closed, Goal) :-
...
%La heuristica se usa para decidir cual es la mejor opcion.
insert_list([], L, L).
